...
<html lang="en">
    <head>
        ...
        <!-- for admin coordinator signature -->
        <script>
            function coordinatorCheck() {
                if (document.getElementById("coordinator").selected || document.getElementById("adminn").selected) {
                    document.getElementById("coorfile").style.display = "block";
                    document.getElementById("txtcoorsig").required = "true";
                }
                else {
                    document.getElementById("coorfile").style.display = "none";
                    document.getElementById("txtcoorsig").required = false;
                    document.getElementById("txtcoorsig").value = "NA";
                }
            }
        
            function hideBtn() {
                var edtbtn = document.getElementById("edit");
                var createbtn = document.getElementById("sc");
                var updatebtn = document.getElementById("su");
                if (edtbtn.style.display === "none") {
        ...
        <nav>
            ...
            <div class="action">
                ...
                <div class="menu">
                    ...
                    <ul>
                        ...
                        <li><img src="images/settings.png" alt=""><a href="#" onclick="document.getElementById('id04').style.display='block'">Settings</a></li>
            ...
            <div class="nav-links">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="nav-item"><a class="nav-link"  data-toggle="tab" href="#admarks">Interview Result 
                    <i style='color: #000;' class='fa fa-check-square'></i></a></li>
                    <li class="nav-item"><a class="nav-link"  data-toggle="tab" href="#adadmin">School Officer 
                    <i style='color: #000;' class='fa fa-user-plus'></i></a></li>
        ...
        <div id="id04" class="modal">
            <form class="modal-content animate" action="" method="post">
                <div class="imgcontainer">
                    ...
                    <img src="images/urslogo.png" alt="" class="avatar">
                    <h3 style="color:#000">Settings</h3><br>
                    
                    <input type="text" class="form-control" placeholder="Campus Name">
                    <input type="submit" value="Add Campus"><br><br>
                    <input type="text" class="form-control" placeholder="Course Name">
                    <input type="submit" value="Add Course"><br><br>
                    <input type="text" class="form-control" placeholder="Requirement">
                ...
                <div class="tab-content"  style="z-index:1;">
                    ...
                    <div id="admarks" class="tab-pane fade">
                        ...
                        <div class="container"><center> 
                            <div class="jumbotron" style="background-color: #06304d; width:50%; color: #fff; box-shadow: -3px 3px 10px #999999;   margin-top:20px;">
                                <div class="row">
                                    <div class="col-sm-6"> 
                                        
                                        APPLICANT ID: 
                                            <select name="intrvwof" id="searchapp"  class="form-control" style="width:200px;">
                                                
                                                <?php
                                                $rs4 = mysqli_query($con,"SELECT * FROM t_user");
                                        ...
                                        <br>
                                        APPLICANT NAME:
                                        <input type="text" name="intname" id="searchappname" class="form-control" placeholder="Name (optional)" style="width:200px;"/> 

                                    </div>
                                    
                                    <div class="col-sm-6">
                                        COLLEGE OF:
                                        <select type="text" name="txtcourse" class="form-control" style="width:200px;" >
                                            <option value="" disabled selected hidden>Choose College</option>
                                        ...
                                        <br>
                                        INTERVIEW RATING:
                                        <input type="number" step="0.01" min="1"  max="5" name="txtintrvwGrd" placeholder="Enter Interview Grade" class="form-control" style="width:200px;" />
                                    </div> 
                                </div><br>
                                <input type="submit" value="Submit" name="submitInt" class="btn"  />
                            </div></center>
                        </div>
                    ...
                    <div id="adadmin" class="tab-pane fade">
                        <div class="row100" style="gap:1rem;">
                            <div class="form"  style="background-color: #06304d; width: 45%; color: #fff;">
                                <h2>New Officer Details</h2>
                                <div class="row">
                                    <div class="col-sm-6"> 
                                        <input type="text" id="txtname"  name="txtname" class="form-control" style="width:200px;" placeholder="Full Name" ><br>
                                    </div>
                                    <div class="col-sm-6"> 
                                        <input type="email" id="txteml"  name="txteml" class="form-control" style="width:200px;" placeholder="Email Address" ><br>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6"> 
                                        <input type="text" id="txtnameuid"  name="txtnameuid" class="form-control" style="width:200px;" placeholder="Username"><br>
                                    </div>
                                    <div class="col-sm-6" style="align-items:center;">
                                        <select type="text" id="txtuserlevel" name="txtuserlevel" class="form-control" style="width:200px;" onchange="coordinatorCheck()" >
                                            <option value="" disabled selected hidden>USER LEVEL</option>
                                            <option id="adminn" value="ADMIN">ADMIN</option>
                                            <option id="coordinator" value="COORDINATOR">COORDINATOR</option>
                                            <option id="ro" value="REGISTRAR OFFICER">REGISTRAR OFFICER</option>
                                            <option id="staff" value="STAFF">STAFF</option>
                                        </select>                                
                                    </div>
                                </div>
                                <div class="row">
                                    <div id="coorfile" class="col" style="display:none;"> 
                                        <input type="file" id="txtcoorsig"  name="txtcoorsig" style="width:55%; font-size: 13px;margin-left:20%;"><br>
                                    </div>
                                </div>
                                <div class="x">                                
                                <p style="font-size:15px;"><h5 style="color:red;">Note:</h5> Write the username to deactivate a certain officer.</p>

                                    <input type="submit" value="Create" name="admcreate" class="btn">
                                    <input type="submit" value="Deactivate" name="admdelete" class="btn">
                                </div>
                            </div>
                            
                            <div class="form" style="background-color: #06304d; width: 60%;">
                                <h2>Existing School Officer/s</h2><br>
                                <div class="sy" style="height:200px;overflow-y:scroll">
                                    <table class="content-table">
                                        <thead>
                                            <tr>
                                                <th>NAME</th>
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                if ($ar[7] == 'Active') {
                                                    echo "<td style='text-align:center;'><a class='adstat' style='background-color:#90EE90;'>" . $ar[7] . "</a></td>";
                                                }else{
                                                    echo "<td style='text-align:center;'><a href='includes/activate.inc.php?id=".$ar[0]."' class='adstat' style='background-color:#E9967A;'>" . $ar[7] . "</a></td>";
                                                }
                                                ?>
                                            </tr>
