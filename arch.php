...
<html lang="en">
    ...
    <body class="container">
       <div class="">
        ...
        <h1 style="text-align:center;">ARCHIEVED LIST</h1>
        <h3>STATUS: <input type="text" id="searchtb" name="searchtb" value="Archieved" style="width:200px; padding:5px; text-align:center;border:none; border-bottom:1px solid #000;" placeholder="All Applicants"></h3>
                ...
                <tbody style="text-align:left;">
                    <?php
                        ...
                        <tr style='font-size:13px;'>
                            ...
                            if ($status == 'Archived') {
                                echo "<td style='text-align:center;'><a href='includes/appactivate.inc.php?id=".$ar[0]."' class='adstat' style='background-color:#E9967A;'>" . $status . "</a></td>";
                            }else{
